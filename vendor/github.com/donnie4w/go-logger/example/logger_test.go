...
func Test(t *testing.T) {
	...
	for i := 100; i > 0; i-- {
		go func() {
			lg.Debug("Debug hello world >>>>>>>>>>>>>>>>>>", strconv.Itoa(i))
			lg.Info("Info hello world >>>>>>>>>>>>>>>>>>>>", strconv.Itoa(i))
			lg.Warn("Warn hello world >>>>>>>>>>>>>>>>>>>>", strconv.Itoa(i))
			lg.Error("Error hello world >>>>>>>>>>>>>>>>>>", strconv.Itoa(i))
			lg.Fatal("Fatal hello world >>>>>>>>>>>>>>>>>>", strconv.Itoa(i))
		}()
	}
